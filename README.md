...
**Project description:** $25 million 5-month project at the Dearborn engine plant, which included demo and installation of multiple machining engine lines.
- Managed engineering documentation control and revision tracking for large-scale industrial installation project.
- Created, updated, and marked up as-built drawings based on field changes
...
- Developed and modified software, improving usability and efficiency of robotics software (Acquired experience with multiple coding languages)
...
- Conducted simulated cyberattacks through external interface, including denial-of-service (DoS), spoofing, and impersonation, to evaluate vehicle network vulnerabilities and support development of defensive strategies
